  ...
  if(CXX_SVE_FOUND)
    if(CXX_SVE128_FOUND)
      ...
      if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -march=armv8.2-a+sve -DCPU_CAPABILITY_SVE -msve-vector-bits=128")
      else()
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -march=armv8.2-a+sve -DCPU_CAPABILITY_SVE -msve-vector-bits=128")
      endif()
    ...
    if(CXX_SVE512_FOUND)
      ...
      if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -march=armv8.2-a+sve -DCPU_CAPABILITY_SVE -msve-vector-bits=512")
      else()
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -march=armv8.2-a+sve -DCPU_CAPABILITY_SVE -msve-vector-bits=512")
      endif()
