...
void InputBuffer::add(
  ...
  //  (1) var is not a CUDA/XPU/privateuse1 variable. Accumulation happens on
  //  var's device. (2) var is a CUDA/XPU/privateuse1 variable and it, the
  ...
  //  (3) var is a CUDA/XPU/privateuse1 variable and it shares a device with the
  ...
  //  (4) var is a CUDA/XPU/privateuse1 variable and it shares a device with the
  ...
  //  (5) var is a CUDA/XPU/privateuse1 variable and it does not share a device
